...
source("../Nico_CRT_Functions_v1.1.R")
...
SimpleRareToPrev.f(otu_fp="/Users/kiristern/Downloads/InputFile_EnglishChannel_L4.txt",abund_thresh=0.005, abund_thresh_ALL=FALSE,b_thresh=0.90, rdp_lastcol=TRUE)
