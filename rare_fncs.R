#source all R scripts from TSA package folder (unable to download in RStudio cause outdated)
file.sources = list.files("/Users/kiristern/Desktop/Shapiro_lab/TSA/R", 
